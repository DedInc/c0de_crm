...
async def handle_notify_staff(request: web.Request) -> web.Response:
    """Handle notification to CRM staff members.

    Supports new orders, assignments, responses, and chat access.
    """
    telegram_id = None
    try:
...
def _create_staff_reply_markup(order_id: str, user_id: int) -> InlineKeyboardMarkup | None:
