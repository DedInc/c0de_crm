...
async def set_language_handler(callback: CallbackQuery) -> None:
    """Set user language."""
    ...
    await callback_message.edit_text(get_text("language_changed", user_id))

    sent = await callback_message.answer(
