...
from core.config import BOT_TOKEN, REDIS_URL, WEBHOOK_HOST, WEBHOOK_PORT
...
async def main() -> None:
    ...
    if REDIS_URL:
        try:
            ...
            logger.info("Using RedisStorage for FSM persistence")
        except Exception as e:
            logger.warning(f"Failed to connect to Redis, falling back to MemoryStorage: {e}")
