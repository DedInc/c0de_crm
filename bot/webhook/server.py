...
from .utils import require_internal_auth, set_bot
...
def create_app() -> web.Application:
    ...
    app = web.Application()
    app.router.add_post("/send-message", require_internal_auth(handle_send_message))
    app.router.add_post("/notify", require_internal_auth(handle_notify))
    app.router.add_post("/verify-telegram", require_internal_auth(handle_verify_telegram))
    app.router.add_post("/notify-staff", require_internal_auth(handle_notify_staff))
