<script lang="ts">
	...
	import { user, isAuthenticated, logout, hasPermission, isAdmin } from '$lib/stores/auth.svelte';
	import { t, locale, setLocale, type Locale } from '$lib/i18n';
	import { theme, setTheme, type Theme } from '$lib/stores/theme.svelte';
	import { initDisplayCurrency } from '$lib/stores/currency.svelte';
	import { Button } from '$lib/components/ui/button';
	import * as DropdownMenu from '$lib/components/ui/dropdown-menu';
	import { Separator } from '$lib/components/ui/separator';
	import { ThemeToggle } from '$lib/components/ui/theme-toggle';
	import { CurrencySelector } from '$lib/components/ui/currency-price';
	...
	const navItems: NavItem[] = [
		...
		{ href: '/currencies', label: 'nav.currencies', icon: Coins, adminOnly: true },
		{ href: '/audit', label: 'nav.audit', icon: FileText, adminOnly: true }
	];
